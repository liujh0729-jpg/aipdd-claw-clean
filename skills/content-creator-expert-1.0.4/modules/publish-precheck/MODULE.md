...
---
> **EN:** Pre-publish risk self-check & meaning-preserving repair for Douyin/XHS/WeChat Channels: reviews scripts, articles, notes and subtitles, outputs issue locations, rule citations and ready-to-use replacement drafts; post-penalty retrospection; personal rule base.
>
...
本版本聚焦文本；用户主动提供了封面/画面图片时可顺手检查图中文字（尽力而为），并说明正式的画面检查清单在后续版本完善。报告里写明本次审了什么、没审什么。
...
`data/` 是用户的资产：升级 Skill 时保留 data/ 下的用户数据，不覆盖、不重置；用户可随时手工编辑，编辑错了 scan 会跳过该行并提示。
