...
---
> **EN:** Video study analysis: understand local videos with Qwen multimodal models and produce illustrated study-summary webpages.
>
...
- 不要把用户给的 key 写入 `MODULE.md`、脚本、报告、HTML、终端日志或最终回复。
