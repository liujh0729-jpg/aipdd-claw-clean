> **EN:** Cross-theme shared components: code blocks, images/GIFs and small-tag headings used by every theme.
>
...
```html
<span style="background:#F1F5F9;color:#DC2626;padding:1px 6px;border-radius:4px;font-family:'SF Mono',Consolas,Monaco,monospace;font-size:14px;"><span leaf="">MODULE.md</span></span>
```
