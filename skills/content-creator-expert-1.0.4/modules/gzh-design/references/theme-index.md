> **EN:** Theme index & selection decision table — the single source of truth for themes; maps choices to component-library files and body-underline CSS.
>
# 主题索引与选择决策表
...
1. 把主题组件库写入 `references/theme-{英文标识}.md`（格式要求见 MODULE.md「添加新主题的规范」）。
